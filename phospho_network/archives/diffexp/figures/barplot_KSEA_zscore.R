...
for (m.cutoff in 2:2) {
  for (NetworKIN.cutoff in 5:5) {
    ...
    # for (cancer in c("BRCA", "OV", "CO", "UCEC")) {
      df <- fread(input = paste0("/Users/yigewu/Box\ Sync/", "cptac2p/cptac_shared/analysis_results/phospho_network/classify/tables/runKSEA_genomic_matched/OmniPath_NetworKIN_", 
