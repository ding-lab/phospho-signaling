...
mut_genes <- c("TP53")
cna_genes <- c("TP53")
rna_genes <- c("CDK1", "PLK1")
# pro_genes <- c("CDK1", "PLK1", "TP53BP1")
# pho_genes <- c("TP53BP1")
# pro_genes <- c("CDK1", "PLK1", "ATR")
# pho_genes <- c("ATR")
# pro_genes <- c("CDK1", "PLK1", "FOXO3")
# pho_genes <- c("FOXO3")
pro_genes <- c("CDK1", "PLK1")
pho_genes <- c("TP53BP1", "FOXO3", "ATR")
# rsds <- c("S1623", "S1099S1106")
# rsds <- c("T1989", "S428")
# rsds <- c("S43", "S284")
# rsds <- c("S43", "S553")
rsds <- c("S1623", "S43", "T1989")
