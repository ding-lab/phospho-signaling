...
for (i in 5) {
  ...
  esscore_tab_fn <- paste0("./cptac2p/analysis_results/phospho_network/es_score/table/calculate_es_pair_score/kinase/sscore_tab", "_", cancer, "_", enzyme_type, "_reg_nonNA", reg_nonNA, ".txt")
  ...
  fn <- paste0(makeOutDir(resultD = resultD),
               "fisher_stat_tab_sscore_outlier", outlier_sd, "SD_highstage", cancer, "_", enzyme_type, "_reg_nonNA", reg_nonNA, ".txt")
