...
mut_cnv_cans_p_adjusted <- mut_cnv_cans_p_adjusted[order(mut_cnv_cans_p_adjusted$fdr),]
...
mut_cnv_cans_smgs_p_adjusted <- mut_cnv_cans_smgs_p_adjusted[order(mut_cnv_cans_smgs_p_adjusted$fdr),]
