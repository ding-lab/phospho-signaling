...
rna_tab <- fread(input = "./Ding_Lab/Projects_Current/CPTAC3-GBM/Data_Freeze/cptac3_gbm_data_freeze_v2.1.20190927/gene_expression/washu/rnaseq_washu_fpkm.v2.1.20190927.tsv.gz", data.table = F)
...
mut_gene <- "RB1"; exp_gene <- "CDK2"; exp_site <- "PRO"; mut_gene_upstream <- NULL
mut_gene <- "RB1"; exp_gene <- "CDK2"; exp_site <- "RNA"; mut_gene_upstream <- NULL
mut_gene <- "RB1"; exp_gene <- "CDK6"; exp_site <- "PRO"; mut_gene_upstream <- NULL
mut_gene <- "RB1"; exp_gene <- "CDK6"; exp_site <- "RNA"; mut_gene_upstream <- NULL
mut_gene <- "NF1"; exp_gene <- "SPRED1"; exp_site <- "PRO"; mut_gene_upstream <- NULL
mut_gene <- "NF1"; exp_gene <- "SPRED1"; exp_site <- "RNA"; mut_gene_upstream <- NULL
