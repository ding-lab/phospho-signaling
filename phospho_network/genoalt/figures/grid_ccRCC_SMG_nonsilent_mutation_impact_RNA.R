...
# input dependencies ------------------------------------------------------
result_df <- fread(input = "./analysis_results/phospho_network/genoalt/tables/test_ccRCC_SMG_mut_impact_global_protein_RNA/20210329.v1/ccRCC_not_silent_mut_impact_RNA.tsv", data.table = F)
...
png(file2write, width = 900, height = 600, res = 150)
print(p)
dev.off()
