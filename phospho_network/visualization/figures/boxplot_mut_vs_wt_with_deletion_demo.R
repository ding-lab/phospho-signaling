...
source('./Ding_Lab/Projects_Current/PanCan_Phospho-signaling/phospho-signaling_analysis/p53/TP53_shared.R')
...
enzyme <- "PBRM1"; substrate <- "SMARCC1"; rsd <- "PRO"; enzyme_upstream <-  NULL

## make directory
subdir1 <- paste0(makeOutDir(), enzyme, "/")
dir.create(subdir1)
