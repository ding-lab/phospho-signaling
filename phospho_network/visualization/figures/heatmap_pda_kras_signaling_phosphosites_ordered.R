...
vaf_df <- fread(data.table = F, input = "./Resources/PDA/Data/data_for_heatmap_v2.tsv")
...
## order columns
plot_data_mat <- plot_data_mat[, column_order_vec]
## get ids
...
p <- Heatmap(matrix = plot_data_mat,
             col = colors_heatmapbody, na_col = color_na,
             ## column
             cluster_columns = F,
