...
regression <- fread(input = paste0("./Ding_Lab/Projects_Current/PanCan_Phospho-signaling/analysis_results/phospho_network/regression/tables/run_regression_with_enzyme_phosphosites_BRCA_altered_kinases/regression_cptac2p_BRCA_tumor_CDAP_scaled_nonNA20.20190821.v1.txt"),
                    data.table = F)
