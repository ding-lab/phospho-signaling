...
# see if NetKIN affect protein level search -------------------------------
ptms_pairs_netkin <- ptms_site_pairs_sup[ptms_site_pairs_sup$Source == "NetKIN",]; nrow(ptms_pairs_netkin)
ptms_pairs_netkin_not <- ptms_site_pairs_sup[ptms_site_pairs_sup$Source != "NetKIN",]; nrow(ptms_pairs_netkin_not)
# ptms_pairs_netkin$pair_pro[!(ptms_pairs_netkin$pair_pro %in% ptms_pairs_netkin_not$pair_pro)]
