...
for (sample_type in c("tumor")) {
  pro_data <- fread(input = "Ding_Lab/Projects_Current/CPTAC3-GBM/Data_Freeze/cptac3_gbm_data_freeze_v2.0.20190905/proteome/pnnl/proteome_pnnl_per_gene_d4.v2.0.20190905.tsv.gz", data.table = F)
  head(pro_data)
  ...
  pho_data <- fread(input = "Ding_Lab/Projects_Current/CPTAC3-GBM/Data_Freeze/cptac3_gbm_data_freeze_v2.0.20190905/phosphoproteome/pnnl/phosphoproteome_pnnl_d6.v2.0.20190905.tsv.gz", data.table = F)
  head(pho_data)
